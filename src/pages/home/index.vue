			...
			<view class="home-video">
				<!-- <video style="height: 1120rpx; width: 100%;" :muted="true" :loop="true" :autoplay="true"
					...
					<image style="height: 1120rpx; width: 100%;" mode="aspectFill"
						src="http://pet-miniapp-test.oss-cn-shenzhen.aliyuncs.com/media/20241025/3p0tc8uMtyDvb3atweqNdHxwaNtUdbWzUr7y6fMV.png"></image>
			</view>
			<view class="home-operating flex justify-end items-center">
				<view class="home-button home-mbti" @click="toAssessment('2')">
					<!-- <view>喵喵MBTI测评</view> -->
					<view class="home-button-icon" style="width:100%;height: 100%; background-repeat: no-repeat; background-size: cover; background-image: url('http://47.238.229.145:8000/media/20241108/QMdEifybyGQ6K4T4rtw7VY56NpmL4XL80u9Ob85L.png');">
				...
				<view class="home-button home-eval" @click="toAssessment('3')">
					<!-- <view>定制健康测评</view> -->
					<view class="home-button-icon" style="width:100%;height: 100%; background-repeat: no-repeat; background-size: cover; background-image: url('http://47.238.229.145:8000/media/20241108/Sgk6WETT1GVMPbpBYoDz1eMtmrwOI08v1d2ApVBW.png');">
						<!-- <image src="/static/images/icon/right.png" mode="aspectFill"></image> -->
					</view>
				</view>
			</view>
